...
execute_process(
  COMMAND "/usr/bin/git" show-ref "b9d4073a6913891ce9cbd8965c8d506075d2a45a"
  WORKING_DIRECTORY "/root/tensorflow/build/xnnpack"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/root/tensorflow/build/xnnpack'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/root/tensorflow/build/xnnpack'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
