...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v2.19.0"
  WORKING_DIRECTORY "/root/tensorflow/build/tensorflow-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/root/tensorflow/build/tensorflow-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/root/tensorflow/build/tensorflow-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
