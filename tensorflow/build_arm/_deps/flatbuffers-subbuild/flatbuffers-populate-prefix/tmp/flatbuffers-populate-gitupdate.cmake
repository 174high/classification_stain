...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v23.1.21"
  WORKING_DIRECTORY "/root/tensorflow/build/flatbuffers"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("v23.1.21" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/v23.1.21")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/root/tensorflow/build/flatbuffers'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/root/tensorflow/build/flatbuffers'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
